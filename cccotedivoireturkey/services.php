<?php include 'header.php'; ?>
        <div class="leftContent">
            <ul class="toogleHead">
                <li>
                    <span class="contentHeader arrow">Hizmetlerimiz</span>
                </li>
                <li>
                    <p class="contentText visible">İki ülke arasındaki ticaret hacminin büyümesi, desteklenmesi ve başka iş alanlarında bağlantılı
            ...
            <!--OFİS HİZMETLERİMİZ-->
            <ul class="toogleHead">
                <li><span class="contentHeader s16 arrow">Ofis Hizmetleri</span></li>
                <li><p class="contentText visible">
            ...
            <ul class="toogleHead">
                <li><span class="contentHeader s16 arrow">Fildişi Sahili ve Türkiye'de Üyelere Özel Hizmetlerimiz</span></li>
                <li> <p class="contentText visible">
            ...
            <ul class="toogleHead">
                <li><span class="contentHeader s16 arrow">Ticari Hizmetlerimiz</span></li>
                <li><p class="contentText visible">
                        ...
                        Aşağıda bu konuları kısa da olsa bir incelemenizde yarar var.<br /><br />

                        <span class="inHead">İş Ortağı Arama</span><br />
                        Hedefiniz yeni pazarlar ise, yatırımcılar  ile işinizi genişletmek istiyorsanız veya yatırım için proje arıyorsanız lütfen odamıza başvrun.<br /><br />
                        ...
                        en doğru yolu size gösterecektir.<br /><br />
                        ...
                        Tanıtım çalışmaları için tüm profuksiyonları gerçekleştirir,  destek olur.<br /><br />
